            ...
            <div className="w-full flex flex-row flex-nowrap items-center ">
              ...
              <div className="flex flex-row items-center justify-center shrink-0 p-1">
                <img
                  ...
                  /* Adaptive background: light grey in light mode, dark grey in dark mode */
                  className="w-12 h-12 sm:w-16 sm:h-16 md:w-20 md:h-20 object-contain rounded p-1 bg-slate-200/80 dark:bg-slate-800/90 border border-slate-300/50 dark:border-slate-700/60 shrink-0"
